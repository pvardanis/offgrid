...
def test_a_typed_window_within_both_bounds_reads_as_the_number():
...
def test_a_typed_window_that_is_not_a_whole_number_is_refused():
...
def test_a_typed_window_of_zero_or_below_is_refused():
...
def test_a_typed_window_below_the_floor_is_refused_with_the_floor_message():
...
def test_a_typed_window_is_not_measured_against_a_floor_no_agent_stated():
...
def test_a_typed_window_is_not_measured_against_a_ceiling_the_runtime_omits():
